...
class _AddRoomDialogState extends State<AddRoomDialog> {
  ...
  Future<void> _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await _roomService.createRoom(_nameController.text.trim(), _selectedType);
        if (mounted) {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Text('Ajouter une pi\u00e8ce', style: TextStyle(color: AppTheme.textPrimaryC(context))),
      content: Form(
        key: _formKey,
        child: Column(
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.meeting_room, color: AppTheme.primaryColor),
            ...
            Text('Type de pi\u00e8ce', style: TextStyle(fontWeight: FontWeight.w500, color: AppTheme.textPrimaryC(context))),
                  ...
                  return InkWell(
                    onTap: () {
                      setState(() {
                        ...
                        final isRoomTypeName = _roomTypes.any((t) => t['name'] == currentText);
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: isSelected
                            ? AppTheme.primaryColor.withOpacity(AppTheme.isDark(context) ? 0.2 : 0.1)
                            : AppTheme.cardBg(context),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: isSelected ? AppTheme.primaryColor : AppTheme.borderLight(context),
                          width: 2,
                        ),
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isSelected ? AppTheme.primaryColor : AppTheme.textPrimaryC(context),
                            ),
                          ),
                        ],
                      ),
